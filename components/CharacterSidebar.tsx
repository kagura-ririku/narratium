        ...
        {!isCollapsed && (
          <>
            ...
            <div className="relative">
              <div 
                className={`menu-item flex items-center p-2 mx-4 md:mx-6 rounded-md hover:bg-[#252525] cursor-pointer overflow-hidden transition-all duration-300 group ${showGithubPresetDropdown ? "bg-[#252525]" : ""}`}
              ...
              {showGithubPresetDropdown && (
                <div className="absolute left-0 right-0 mt-1 mx-4 md:mx-6 bg-[#1c1c1c] border border-[#333333] rounded-md shadow-lg z-10 overflow-hidden">
